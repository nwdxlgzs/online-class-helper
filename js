$(".userLogin .username").val("110228200302173855"); $(".userLogin .password").val("123456");var btn_a = document.querySelectorAll('span[type]')[0];if (btn_a != null || btn_a != undefined) {  var btn_b = document.querySelectorAll('span[type]')[1];btn_a.click();};
//javascript:
